...
const AngleOfTriangle = () => {
  ...
  function buttonHandler(event) {
    ...
    sumOfAngle <= 180
      ? setOutputMessage(
          "Output : Hurray! A triangle can be formed from the given angles"
        )
      : setOutputMessage(
          "Output : Oops! A triangle cannot be formed from the given angles"
        );
  }
